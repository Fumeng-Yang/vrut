...
plot_mould <- function(uni, set, gap, thresholds, lmax, Hz){
    # https://github.com/cran/gazepath/blob/master/R/plotMould.R
    null <- rep(0, Hz)
    plot(set ~ thresholds, ylim = c(0,max(set)), col = 'grey30', type = 'l', bty = 'n', ylab = '', xlab = 'Speed thresholds, deg/s', xaxt = 'n', las = 2, main = 'Velocity threshold estimation')
